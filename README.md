...
- [Google Fonts](https://fonts.google.com/){:target="_blank" rel="noopener"} – Para tipografías personalizadas
- [Google Fonts – Inter](https://fonts.google.com/specimen/Inter){:target="_blank" rel="noopener"} – Fuente principal del proyecto
- [CSS-Tricks](https://css-tricks.com/){:target="_blank" rel="noopener"} – Artículos y guías avanzadas de CSS
- [Can I Use...](https://caniuse.com/){:target="_blank" rel="noopener"} – Soporte de navegadores para features modernas