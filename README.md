...
- [Google Fonts – Inter](https://fonts.google.com/specimen/Inter) – **Fuente principal del proyecto**

## Recursos avanzados
- [CSS-Tricks](https://css-tricks.com/) – Artículos y guías avanzadas de **CSS**
- [Can I Use...](https://caniuse.com/) – **Soporte** de navegadores para features modernas

## Favicon
- [Favicon generator](https://favicon.io/) – Herramienta para la creación del **favicon**

## Generadores de tablas y CSS
- [CSS Generator](https://cssgenerator.dev/) – Generador de **CSS** con interfaz visual
- [Tablas](https://www.tablesgenerator.com/html_tables) – Generador de **tablas** para HTML
